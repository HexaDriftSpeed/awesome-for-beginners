...
If you are a maintainer of open-source projects, add the label `first-timers-only` (or similar) to ghyour project and list it here so that people can find it.
fgb
